...
IDENT    = "&id="+raw_input("  Enter IDENT   : ")
FULLNAME = "&full="+raw_input("  Enter FULLNAME: ")
ADDRESS1 = "&a1="+raw_input("  Enter ADDRESS1: ")
CITY     = "&city="+raw_input("  Enter CITY    : ")
STATE    = "&state="+raw_input("  Enter STATE   : ")
ZIP      = "&postal="+raw_input("  Enter ZIP     : ")
